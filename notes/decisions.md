...
| Q5 bandwidth arm | Pinned mixed 4.951-bpw target at revision `596b8067...8340` | Exact required-language inventory passes; selected A100 reaches **19.134907634 tok/s** across two clean windows, **+5.591%** over generic mixed execution |
