...
POSITIONAL_FIELD_ORDER = (
    ...
    "speculative_swor_collect_path_stats",
    "speculative_swor_collect_overlap_stats",
    "speculative_swor_topology",
    "speculative_pq_capture_path",
    "speculative_pq_capture_max_cycles",
    "speculative_graph_gap_timing_path",
    "speculative_graph_gap_timing_max_samples",
