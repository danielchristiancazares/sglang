...
class Envs:
    ...
    # An explicit setting takes precedence over the CI-sensitive default.
    ...
    SGLANG_DSPARK_TRUNCATED_DRAFT_SAMPLING = EnvBool(False)
    SGLANG_DSPARK_SPARSE_ACCEPT = EnvBool(False)
    SGLANG_DSPARK_STACKED_CTX_KV = EnvBool(True)
    SGLANG_DSPARK_STATIC_GRAPH_KV_COMMIT = EnvBool(False)
