...
class MlxTpModelWorker(TpModelWorker):
    ...
    def _init_model_runner(self):
        ...
        init_kwargs = dict(
            ...
            kv_cache_bits=self.server_args.mlx_kv_cache_bits,
            kv_cache_group_size=self.server_args.mlx_kv_cache_group_size,
            mtp_path=self.server_args.mlx_mtp_path,
            mtp_depth=self.server_args.mlx_mtp_depth,
