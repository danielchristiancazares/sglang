...
| Mixed-Q5 actual-work owner | Rerun `6237 / 32 warm / 256 timed` with A149/A150/A163; then attribute any remaining long-history gap | The pre-verifier baseline has five exact A137 processes at **19.038932103 tok/s**. A163 clears 20 only on the short standard-MTP gate, so no actual-work standing transfers without a matched long-history measurement |
