...
| Q5 bandwidth arm | Pinned mixed 4.951-bpw target at revision `596b8067...8340` | Exact required-language inventory passes; selected A100+A111+A114+A113+A117+A128+A137 reaches matched two-window **19.667930618 tok/s**, **+8.533%** over generic mixed execution; exact 131K and `xhigh` remain open |
...
| Mixed-Q5 actual-work owner | Reduce Q5 streamed bytes or decode instructions; retain the `6237 / 32 warm / 256 timed` window as the long-history baseline | Five exact A137 processes mean **19.038932103 tok/s**, **5.047909%** execution improvement short of 20. Metal counters assign **49.061847%** of PCs to Q5 versus **3.863774%** to two-pass SDPA, so attention-only and submission-only tuning cannot close the complete gap |
