...
| Candidate | Status | Why |
|---|---|---|
| Bartowski Qwen3.8-27B Q5_K_S with one F16 token embedding | Active Q5 serving base | The immutable pinned Q5_K_S source hashes to `b52fbc24...e569`. Pinned llama.cpp build 10547 copies all 865 remaining tensors and converts only `token_embd.weight`; the 21,349,656,160-byte derivative hashes to `c05a7778...fcfb`, passes Q4_0/Q5_K/Q6_K native-MPS parity, and loads at 21.37 GB. With the selected Q6_K and Q5_K batch-one kernels it averages **7.1646 tok/s** across five sampled exact `128+32` requests, versus the **5.746 tok/s** generic-kernel baseline. Real 131K capacity and the 20 tok/s floor remain active. |
